...
export const prepareComponentToken: GetDefaultToken<'Menu'> = (token) => {
  ...
  return {
    ...
    itemActiveBg: '#ea9ec8',//controlItemBgActive,
    colorSubItemBg: colorFillAlter,
    subMenuItemBg: colorFillAlter,
    colorItemBgSelected: controlItemBgActive,
    itemSelectedBg: '#ea9ec8', //controlItemBgActive,
    ...
    darkItemSelectedBg: '#ea9ec8',//,colorPrimary,
  ...
  const useStyle = genStyleHooks(
    ...
    (token) => {
      ...
      const menuDarkToken = mergeToken<MenuToken>(menuToken, {
        ...
        itemSelectedBg: '#ea9ec8',//darkItemSelectedBg,
        activeBarHeight: 0,
